...
# # print(np.random.choice(len(res)))
# out = res[np.random.choice(len(res))] # a is input
# print(out)
# print(random.choice(out, size = 10, replace = False))
# #b = random.choice(res, size=5, replace=False)
